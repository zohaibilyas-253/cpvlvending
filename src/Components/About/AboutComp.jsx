      ...
      <div id="page_wrapper" className="wrapper">
        ...
        <header className="header-no-bg p-relative v-dark-head dsn-header-animation over-hidden">
          ...
          <div className="content p-relative z-index-1">
            <div className="container">
              <h1 className="title-lg text-upper">About Us</h1>
        ...
        <div className="p-relative over-hidden">
          ...
          <div id="about_us" className="about-section-two section-margin text-center text-effect"
            data-dsn-text="27">
            <div className="container">
              <h2 className="title">Act because you have hands, that bring to life your every command. With
                them
                you can create and build, and bring to life what once was stilled.</h2>
            </div>
          </div>
        ...
        <section className="our-services services-hover">
          <div className="container">
            <div className="title-box w-100 d-flex justify-content-between pb-20 mb-70 border-bottom">
              ...
              <h5 className="sm-title-block text-upper max-w570">We customize our services to match your
                unique requirements. No matter the objective, we'll develop an innovative solution
                to
                bring it to fruition.</h5>
            </div>

            <div className="services-inner d-flex flex-column gap-row-50">
              <div className="services-item text-center">
                <h3 className="title-lg text-upper">strategy</h3>
              ...
              <div className="services-item text-center">
                <h3 className="title-lg text-upper">design</h3>
              ...
              <div className="services-item text-center">
                <h3 className="title-lg text-upper">development</h3>
